...
DISCLAIMER = 'Both the text and the audio of this podcast are AI generated, and inaccuracies or unintended content may exist.'  # Disclaimer about AI generated audio is required by OpenAI as per https://platform.openai.com/docs/guides/text-to-speech/do-i-own-the-outputted-audio-files
