...
from podgenai.util.jinja2_ import load_templates
...
TTS_DISCLAIMER: str = "Both the text and audio in this media are AI-generated and may contain inaccurate or unintended content. The information presented has not been verified or researched, and should not be relied upon as factual or professional advice. This media is independently created and is not affiliated with, authorized by, or endorsed by any organization or entity. Any resemblance or similarity to existing works is coincidental and unintended."
