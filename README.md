...
Although there may exist some semantic repetition of content across subtopics, this has intentionally not been "optimized away" because this repetition of important points can help with learning and memorization. To instead dive deeper into a particular subtopic, one is advised to create a new file just for it.
